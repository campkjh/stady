    ...
    <div className="flex flex-col" style={{ minHeight: "100vh", background: "var(--c-bg)" }}>
      ...
      <div className="flex flex-1 flex-col" style={{ padding: "8px 20px 24px" }}>
        ...
        <div className="space-y-6" style={{ fontSize: 14, lineHeight: 1.7, color: "var(--c-text-3b)" }}>
          ...
          {/* 제2조 */}
          <section>
            <h2 className="mb-2 font-semibold" style={h2Style}>제 2조 (용어의 정의)</h2>
            <table className={tableClass} style={tableStyle}>
              <thead>
                <tr>
                  <th className={thClass} style={{ ...thStyle, width: "25%" }}>용어</th>
                  <th className={thClass} style={{ ...thStyle, width: "75%" }}>정의</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className={`${tdClass} font-medium`} style={tdStyle}>서비스</td>
                  <td className={tdClass} style={tdStyle}>회사가 제공하는 문제집 풀이, OX 퀴즈, 영단어 퀴즈, 학습 기록 관리 등 모바일 및 웹 기반 학습 관련 일체의 서비스</td>
                </tr>
                <tr>
                  <td className={`${tdClass} font-medium`} style={tdStyle}>이용자</td>
                  <td className={tdClass} style={tdStyle}>본 약관에 따라 회사가 제공하는 서비스를 이용하는 회원 및 비회원</td>
                </tr>
                <tr>
                  <td className={`${tdClass} font-medium`} style={tdStyle}>회원</td>
                  <td className={tdClass} style={tdStyle}>회사에 개인정보를 제공하여 회원등록을 한 자로서, 서비스를 지속적으로 이용할 수 있는 자</td>
                </tr>
                <tr>
                  <td className={`${tdClass} font-medium`} style={tdStyle}>콘텐츠</td>
                  <td className={tdClass} style={tdStyle}>서비스 내에서 제공되는 문제집, 퀴즈, 해설 등 일체의 학습 자료</td>
                </tr>
              </tbody>
            </table>
          </section>
          ...
          {/* 제3조 */}
          <section>
            <h2 className="mb-2 font-semibold" style={h2Style}>제 3조 (약관의 게시 및 변경)</h2>
          ...
          {/* 제4조 */}
          <section>
            <h2 className="mb-2 font-semibold" style={h2Style}>제 4조 (회원가입)</h2>
          ...
          {/* 제5조 */}
          <section>
            <h2 className="mb-2 font-semibold" style={h2Style}>제 5조 (서비스의 제공)</h2>
            <p>회사는 다음과 같은 서비스를 제공합니다.</p>
            <table className={tableClass} style={tableStyle}>
              <thead>
                <tr>
                  <th className={thClass} style={{ ...thStyle, width: "30%" }}>서비스</th>
                  <th className={thClass} style={{ ...thStyle, width: "70%" }}>설명</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className={`${tdClass} font-medium`} style={tdStyle}>문제집 풀이</td>
                  <td className={tdClass} style={tdStyle}>다양한 과목·카테고리별 문제집 학습 및 성적 분석</td>
                </tr>
                <tr>
                  <td className={`${tdClass} font-medium`} style={tdStyle}>OX 퀴즈</td>
                  <td className={tdClass} style={tdStyle}>참/거짓 형식의 퀴즈 풀이 및 해설 제공</td>
                </tr>
                <tr>
                  <td className={`${tdClass} font-medium`} style={tdStyle}>영단어 퀴즈</td>
                  <td className={tdClass} style={tdStyle}>4지선다 형식의 영어 단어 학습 퀴즈</td>
                </tr>
                <tr>
                  <td className={`${tdClass} font-medium`} style={tdStyle}>학습 기록 관리</td>
                  <td className={tdClass} style={tdStyle}>풀이 내역, 점수, 오답 노트, 북마크 기능</td>
                </tr>
                <tr>
                  <td className={`${tdClass} font-medium`} style={tdStyle}>고객 지원</td>
                  <td className={tdClass} style={tdStyle}>공지사항, FAQ, 1:1 문의 기능</td>
                </tr>
              </tbody>
            </table>
          ...
          {/* 제6조 */}
          <section>
            <h2 className="mb-2 font-semibold" style={h2Style}>제 6조 (이용자의 의무)</h2>
          ...
          {/* 제7조 */}
          <section>
            <h2 className="mb-2 font-semibold" style={h2Style}>제 7조 (지적재산권)</h2>
            <p>
          ...
          {/* 제8조 */}
          <section>
            <h2 className="mb-2 font-semibold" style={h2Style}>제 8조 (회원 탈퇴 및 자격 제한)</h2>
          ...
          {/* 제9조 */}
          <section>
            <h2 className="mb-2 font-semibold" style={h2Style}>제 9조 (서비스의 변경 및 중단)</h2>
          ...
          {/* 제10조 */}
          <section>
            <h2 className="mb-2 font-semibold" style={h2Style}>제 10조 (면책조항)</h2>
          ...
          {/* 제11조 */}
          <section>
            <h2 className="mb-2 font-semibold" style={h2Style}>제 11조 (분쟁 해결 및 관할)</h2>
          ...
          {/* 부칙 */}
          <section>
            <h2 className="mb-2 font-semibold" style={h2Style}>부칙</h2>
